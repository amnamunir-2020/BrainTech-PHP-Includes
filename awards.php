...
<head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title> Awards & Reviews-Writing Services </title>
    ...
    <body class="defult-home">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="banner-content ">
                                ...
                                <h1 class="title wow fadeinup"> Awards & Reviews</h1>
                                <h2 class="desc wow fadeinup">
                        ...
                        <div class="col-lg-6 pt-100">
                            <img src="assets/images/banner/style4/award.jpg">
     ...
     <!-- Process Section Start -->
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="addon-process">
                    <div class="process-wrap">
                        ...
                        <div class="process-text">
                            <h3 class="title">MOST RELIABLE</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Process Section Start -->
            <div class="rs-process style2  pb-120 md-pt-80 md-pb-73">
                <div class="container">
                <div class="sec-title2 text-center mb-45">
    
                <h2 class="title title2">
                    Best Academic Services 
                </h2>
                </div>
                <div class="row">
                <div class="col-lg-4 col-sm-6 md-mb-50">
                    <div class="addon-process">
                        <div class="process-wrap">
                            <div class="process-img">
                                <img src="assets/images/process/web1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 md-mb-50">
                    <div class="addon-process">
                        <div class="process-wrap">
                            <div class="process-img">
                                <img src="assets/images/process/web2.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="addon-process">
                        <div class="process-wrap">
                            <div class="process-img">
                                <img src="assets/images/process/web3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
